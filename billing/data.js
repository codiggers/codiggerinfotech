...
var ib_invoice_data = {
  ...
  "{company_name}"          : "Codigger Infotech",
  "{company_address}"       : "Phone: +91 846 106 9246",
  "{company_city_zip_state}": "",
  "{company_phone_fax}"     : "www.codigger.consulting ",
  "{company_email_web}"     : "info@codigger.consulting",
